#
#  Be sure to run `pod spec lint FloatingLabelTextFieldSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Habibur Rahamn" => "habibur.sust@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/habib-sust/FloatingLabelTextFieldSwift.git", :tag => "#{spec.version}" }
